...
// 1. Request ID — first so everything downstream has it
...
// 2. Latency tracking — start timer early
app.use(latencyMiddleware);

// 3. Structured logging — log arrival + completion
app.use(requestLogger);

// 4. Failure simulation — AFTER logging so arrivals are always recorded
//    BEFORE routes so simulation affects actual processing
